...
def check_doctor_availability(
    ...
    conflicts = db.query(AppointmentModel).filter(
...
def patient_has_future_appointment_with_doctor(
    db: Session, patient_id: int, doctor_id: int, now: datetime
) -> bool:
...
def check_patient_available_at_time(
    db: Session, patient_id: int, scheduled_datetime: datetime
) -> bool:
...
def get_booked_slots_for_doctor(
    db: Session, doctor_id: int, start_time: datetime, end_time: datetime
) -> list[datetime]:
...
def get_all_appointments_for_patient(
